...
var Icon$W = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 24" }, props),
        React.createElement("path", { d: "M19.2 3H5.19995C4.09995 3 3.19995 3.9 3.19995 5V19C3.19995 20.1 4.09995 21 5.19995 21H19.2C20.3 21 21.2 20.1 21.2 19V5C21.2 3.9 20.3 3 19.2 3ZM19.2 19H5.19995V5H19.2V19Z", fill: "rgb(31, 199, 212)" }),
        React.createElement("path", { d: "M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z", fill: "rgb(31, 199, 212)" }),
        React.createElement("path", { d: "M18.2 15.75H13.2V17.25H18.2V15.75Z", fill: "rgb(31, 199, 212)" }),
        React.createElement("path", { d: "M18.2 13.25H13.2V14.75H18.2V13.25Z", fill: "rgb(31, 199, 212)" }),
        React.createElement("path", { d: "M8.19995 18H9.69995V16H11.7V14.5H9.69995V12.5H8.19995V14.5H6.19995V16H8.19995V18Z", fill: "rgb(31, 199, 212)" }),
        React.createElement("path", { d: "M14.29 10.95L15.7 9.54L17.11 10.95L18.17 9.89L16.76 8.47L18.17 7.06L17.11 6L15.7 7.41L14.29 6L13.23 7.06L14.64 8.47L13.23 9.89L14.29 10.95Z", fill: "rgb(31, 199, 212)" })));
};
...
var Icon$z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React.createElement("g", { clipPath: "url(#clip0)" },
            ...
            React.createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "green" }),
            React.createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "green" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "green" })),
            ...
            React.createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "green" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "green" }))),
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear", x1: "40.9849", y1: "37.4118", x2: "31.978", y2: "71.0261", gradientUnits: "userSpaceOnUse" },
                ...
                React.createElement("stop", { offset: "1", stopColor: "rgb(31, 199, 212)" })),
...
var Icon$s = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 512.002 512.002" }, props),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M67.138,191c-17.46-4.595-36.059-0.163-49.58,12.102c-12.165,11.033-18.521,26.76-17.44,43.147\n\t\t\tc1.082,16.387,9.449,31.142,22.958,40.479l181.976,125.805L67.138,191z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M160.736,123.742c-3.363-14.406-3.414-29.058-0.375-43.031c-11.391-2.724-23.369-2.203-34.726,1.657\n\t\t\tc-18.254,6.203-32.444,20.174-38.932,38.328c-6.487,18.155-4.364,37.955,5.825,54.321l128.241,205.998L160.736,123.742z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M22.737,322.966c-1.061,1.359-2.047,2.79-2.937,4.306c-5.985,10.191-6.973,22.358-2.71,33.382s13.179,19.36,24.464,22.873\n\t\t\tl125.124,38.95L22.737,322.966z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M138.581,453.995c-0.939-0.218-1.885-0.326-2.824-0.326c-2.746,0-5.425,0.921-7.633,2.673\n\t\t\tc-2.962,2.351-4.661,5.868-4.661,9.649c0,3.782,1.699,7.299,4.662,9.649c2.963,2.352,6.774,3.208,10.457,2.348l51.41-11.997\n\t\t\tL138.581,453.995z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M309.129,59.353C296.186,43.042,276.821,33.688,256,33.688c-20.821,0-40.187,9.354-53.129,25.665\n\t\t\tc-12.942,16.311-17.652,37.295-12.921,57.572L256,399.983l66.05-283.058C326.782,96.648,322.072,75.664,309.129,59.353z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M494.443,203.102c-13.522-12.264-32.122-16.698-49.581-12.102L306.949,412.534l181.976-125.805\n\t\t\tc13.509-9.338,21.876-24.093,22.958-40.479C512.964,229.862,506.607,214.135,494.443,203.102z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M492.2,327.272c-0.89-1.515-1.876-2.947-2.937-4.306l-143.941,99.51l125.124-38.95\n\t\t\tc11.285-3.513,20.201-11.85,24.464-22.873C499.173,349.63,498.185,337.463,492.2,327.272z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M383.876,456.342c-2.962-2.351-6.774-3.205-10.457-2.347l-51.41,11.996l51.411,11.997\n\t\t\tc3.681,0.859,7.494,0.004,10.456-2.348c2.962-2.351,4.662-5.867,4.662-9.649C388.537,462.211,386.838,458.693,383.876,456.342z" }))),
        React.createElement("g", null,
            React.createElement("g", null,
                React.createElement("path", { d: "M425.298,120.696c-6.488-18.154-20.678-32.125-38.932-38.328c-11.357-3.859-23.336-4.381-34.727-1.657\n\t\t\tc3.038,13.973,2.987,28.625-0.374,43.031l-60.033,257.273l128.241-205.998C429.662,158.651,431.785,138.851,425.298,120.696z" })))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$K, { className: "mobile-icon" }),
        React.createElement(Logo$1, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$p, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$q, { width: "24px", color: "textSubtle" }))),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$M, { color: "primary", mr: "6px" }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "rgb(71, 95, 123)", textDisabled: "#BDC2C4", textSubtle: "rgb(132, 148, 167)", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
